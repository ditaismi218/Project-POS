...
//             },
//         });
//     var t = document.querySelector(".dt-fixedheader");
//     let s,
//         r =
//             (t &&
//                 ((s = new DataTable(t, {
...
//                             orderable: !1,
//                             render: function (e, t, a, s) {
//                                 return '<div class="d-inline-block"><a href="javascript:;" class="btn btn-icon dropdown-toggle hide-arrow" data-bs-toggle="dropdown"><i class="bx bx-dots-vertical-rounded icon-base"></i></a><div class="dropdown-menu dropdown-menu-end m-0"><a href="javascript:;" class="dropdown-item">Details</a><a href="javascript:;" class="dropdown-item">Archive</a><div class="dropdown-divider"></div><a href="javascript:;" class="dropdown-item text-danger delete-record">Delete</a></div></div><a href="javascript:;" class="btn btn-icon item-edit"><i class="bx bxs-edit icon-base"></i></a>';
//                             },
//                         },
//                     ],
...
//                     orderable: !1,
//                     render: function (e, t, a, s) {
//                         return '<div class="d-inline-block"><a href="javascript:;" class="btn btn-icon dropdown-toggle hide-arrow" data-bs-toggle="dropdown"><i class="bx bx-dots-vertical-rounded icon-base"></i></a><div class="dropdown-menu dropdown-menu-end m-0"><a href="javascript:;" class="dropdown-item">Details</a><a href="javascript:;" class="dropdown-item">Archive</a><div class="dropdown-divider"></div><a href="javascript:;" class="dropdown-item text-danger delete-record"></i>Delete</a></div></div><a href="javascript:;" class="item-edit text-body"><i class="bx bxs-edit icon-base"></i></a>';
//                     },
//                 },
//             ],
//             layout: {
...
//             initComplete: function (e, t) {
//                 r.querySelector("tbody tr:first-child").classList.add(
//                     "border-top-0"
//                 );
//             },
//         })),
...
//                 bootstrap.Modal.getInstance(e)?.hide();
//         }));
//     t = document.querySelector(".dt-select-table");
//     t &&
//         new DataTable(t, {
//             ajax: assetsPath + "json/table-datatable.json",
//             columns: [
