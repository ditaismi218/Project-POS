(() => {
    ...
    (d =
        ((l = isDarkStyle
            ? ((s = "#333457"), (n = "#3c3e75"), "#484b9b")
            : ((s = "#ededff"), (n = "#d5d6ff"), "#b7b9ff")),
        "#696cff")),
    ...
    var p = {
        ...
        c = document.querySelector("#customerRatingsChart"),
        h = {
            chart: {
                height: 212,
                toolbar: { show: !1 },
        ...
        h = {
            chart: { height: 276, type: "radialBar" },
            series: [75],
            labels: ["Sales"],
            plotOptions: {
                radialBar: {
        ...
        h = {
            ...
            legend: { show: !1 },
            grid: { show: !1, padding: { top: -15, left: 16, bottom: -7 } },
            xaxis: {
                labels: {
                    show: !0,
                    style: { colors: t, fontSize: "15px", fontFamily: r },
                },
                axisBorder: { show: !1 },
                axisTicks: { show: !1 },
            },
        ...
        h = {
            ...
            responsive: [
                ...
                },
                {
                    ...
                    options: {
                        plotOptions: {
                            bar: { borderRadius: 11, columnWidth: "55%" },
                        },
                    },
                },
                {
                ...
                },
                {
                    ...
                    options: {
                        plotOptions: {
                            bar: { borderRadius: 12, columnWidth: "40%" },
                        },
                ...
                },
                {
                    ...
                    options: {
                        plotOptions: {
                            bar: { borderRadius: 11, columnWidth: "25%" },
                        },
                    },
                },
                {
        ...
        h = {
            ...
            xaxis: {
                ...
                labels: {
                    offsetX: 0,
                    style: { colors: t, fontFamily: r, fontSize: "13px" },
                },
                axisBorder: { show: !1 },
                axisTicks: { show: !1 },
                lines: { show: !1 },
            ...
            yaxis: {
                labels: {
                    ...
                    style: { fontSize: "13px", fontFamily: r, colors: t },
                },
                min: 1e3,
                max: 6e3,
                tickAmount: 5,
        ...
        h = {
            ...
            xaxis: {
                ...
                axisBorder: { show: !1 },
                axisTicks: { show: !1 },
                labels: { show: !0, style: { fontSize: "13px", colors: t } },
            },
        ...
        h = {
            ...
            plotOptions: {
                radar: { polygons: { strokeColors: a, connectorColors: a } },
            },
            ...
            legend: {
                ...
                fontSize: "13px",
                position: "bottom",
                labels: { colors: i, useSeriesColors: !1 },
        ...
        c =
            (null !== c && new ApexCharts(c, h).render(),
            document.querySelector("#sessionOverviewChart")),
        h = {
            series: [78],
            labels: ["Loss Rate"],
            chart: { height: 175, type: "radialBar" },
            colors: [config.colors.warning],
            plotOptions: {
                radialBar: {
                    offsetY: 0,
                    ...
                    endAngle: 140,
                    hollow: { size: "70%" },
                    track: { strokeWidth: "60%", background: a },
                    dataLabels: {
                        name: {
                            offsetY: 55,
                            color: t,
        ...
        h = {
            ...
            responsive: [
                { breakpoint: 991, options: { chart: { height: "350px" } } },
            ],
            states: {
                hover: { filter: { type: "none" } },
                active: { filter: { type: "none" } },
    ...
    null !== c && new ApexCharts(c, h).render();
    let f = document.querySelector("#horizontalBarChart"),
        y = {
            ...
            dataLabels: {
                ...
                formatter: function (o, e) {
                    return y.labels[e.dataPointIndex];
                },
                offsetX: 0,
    ...
    null !== f && new ApexCharts(f, y).render(),
        (c = document.querySelector("#deliveryExceptionsChart")),
        (h = {
            chart: { height: 396, parentHeightOffset: 0, type: "donut" },
            labels: [
                "Incorrect address",
                "Weather conditions",
                "Federal Holidays",
        ...
        (h = {
            ...
            grid: { strokeDashArray: 8, borderColor: a },
            colors: [p.line.series1, p.line.series2],
            fill: { opacity: [1, 1] },
            plotOptions: {
                bar: {
                    columnWidth: "30%",
