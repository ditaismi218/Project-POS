...
document.addEventListener("DOMContentLoaded", function (e) {
    ...
    t &&
        ...
        document.addEventListener("click", function (e) {
            e.target.classList.contains("delete-record") &&
                (a.row(e.target.closest("tr")).remove().draw(),
                (e = document.querySelector(".dtr-bs-modal"))) &&
                e.classList.contains("show") &&
                bootstrap.Modal.getInstance(e)?.hide();
        }));
    ...
    s &&
        ((n = new DataTable(s, {
            ...
            drawCallback: function (e) {
                var t = this.api();
                let n = t.rows({ page: "current" }).nodes(),
                    r = null;
                t.column(2, { page: "current" })
                    ...
                    .each(function (e, t) {
                        var a, s;
                        r !== e &&
                            ((a = document.createElement("tr")).classList.add(
                                "group"
                            ),
                            (s = document.createElement("td")).setAttribute(
                                "colspan",
                                "8"
                            ),
                            (s.textContent = e),
        ...
        document.addEventListener("click", function (e) {
            e.target.classList.contains("delete-record") &&
                (n.row(e.target.closest("tr")).remove().draw(),
                (e = document.querySelector(".dtr-bs-modal"))) &&
                e.classList.contains("show") &&
                bootstrap.Modal.getInstance(e)?.hide();
        }));
    ...
    t &&
        ((l = new DataTable(t, {
            ...
            layout: {
                ...
                topEnd: {
                    search: { placeholder: "Geben Sie hier die Suche ein" },
                },
                bottomStart: {
                    rowClass: "row mx-3 justify-content-between",
                    features: ["info"],
