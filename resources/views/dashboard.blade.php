            ...
            <div class="d-flex align-items-start row">
                <div class="col-sm-7">
                    <div class="card-body">
                        ...
                        <p class="mb-6">Anda memiliki kendali penuh atas data pengguna dan transaksi.<br />
                            Lihat laporan terbaru untuk memantau perkembangan sistem.
                        </p>
                        <div class="dropdown">
                            <button class="btn btn-sm btn-label-primary dropdown-toggle" type="button" id="dropdownLaporan"
                                data-bs-toggle="dropdown" aria-expanded="false">
                                Lihat Laporan
                            </button>
                            <ul class="dropdown-menu" aria-labelledby="dropdownLaporan">
                                <li><a class="dropdown-item" href="{{ route('laporan.penjualan') }}">Laporan Penjualan</a>
                                </li>
                                <li><a class="dropdown-item" href="{{ route('laporan.transaksi') }}">Laporan Transaksi</a>
                                </li>
                                <li><a class="dropdown-item" href="{{ route('laporan.penerimaan_barang') }}">Laporan
                ...
                <div class="col-sm-5 text-center text-sm-left">
                    <div class="card-body pb-0 px-0 px-md-6">
                        <img src="{{ asset('asset') }}/assets/img/illustrations/sitting-girl-with-laptop.png" height="175"
                        ...
                        <div class="card-title d-flex align-items-start justify-content-between mb-4">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt6">
                                    <a class="dropdown-item" href="{{ route('kategori.index') }}">Lihat Detail</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        <div class="card-title d-flex align-items-start justify-content-between mb-4">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt6">
                                    <a class="dropdown-item" href="{{ route('produk.index') }}">Lihat Detail</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        <div class="card-title d-flex align-items-start justify-content-between mb-4">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt6">
                                    <a class="dropdown-item" href="{{ route('supplier.index') }}">Lihat Detail</a>
                                </div>
                            </div>
                        </div>
                        <p class="mb-1">Jumlah Supplier</p>
                        <h4 class="card-title mb-3">
                            {{ $jumlahSupplier }}
                        </h4>
                        {{-- <a href="{{ route('kategori.index') }}" class="text-primary text-decoration-none">
                    ...
                    <div class="card-body">
                        <div class="card-title d-flex align-items-start justify-content-between mb-4">
                            <div class="avatar flex-shrink-0">
                                <img src="{{ asset('asset/assets/img/icons/unicons/cc-primary.png') }}" alt="Credit Card"
                                    class="rounded" />
                            </div>
                            <div class="dropdown">
                        ...
                        <!-- Ubah Deskripsi dan Data -->
                        <p class="mb-1">Harga Beli Barang</p>
                        <h4 class="card-title mb-3">Rp {{ number_format($totalHargaBeli, 0, ',', '.') }}</h4>
                        <small class="text-success fw-medium">
                            <i class="icon-base bx bx-up-arrow-alt"></i> Data Diperbarui
                        </small>
                    </div>
                </div>
            </div>
...
@push('script')
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            const backgroundColors = ['#6a82fb', '#fc5c7d', '#45b649', '#f9d423', '#f953c6']; // Samakan dengan PHP
            ...
            new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        data: data,
                        backgroundColor: backgroundColors, // Gunakan warna yang sama
                        borderWidth: 0,
                ...
                item.addEventListener("click", async function() {
                    ...
                    try {
                        let response = await fetch(
                            `/admin/dashboard/filter-penjualan?filter=${filter}`);
    ...
    {{-- <script>
        document.addEventListener("DOMContentLoaded", function() {
            var ctx = document.getElementById("lineAreaChart").getContext("2d");

            var chart = new Chart(ctx, {
                type: "line",
                data: {
                    labels: {!! json_encode($labels) !!}, // Data label dari controller Laravel
                    datasets: [{
                        label: "Total Penjualan",
                        data: {!! json_encode($dataPenjualan) !!}, // Data penjualan dari controller Laravel
                        backgroundColor: "rgba(60, 80, 224, 0.2)", // Warna area
                        borderColor: "#3C50E0", // Warna border garis
                ...
                options: {
                    ...
                    scales: {
                        ...
                        y: {
                            ticks: {
                                callback: function(value) {
                                    return value.toLocaleString("id-ID"); // Format ribuan Indonesia
                                },
                                color: "#888"
                            },
                            grid: {
