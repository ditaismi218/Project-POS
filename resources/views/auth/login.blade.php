...
>
  <head>
    ...
    <meta
      property="og:title"
      content="Sneat Bootstrap 5 Dashboard PRO by ThemeSelection"
    />
    <meta property="og:type" content="product" />
    <meta
      property="og:url"
      content="https://themeselection.com/item/sneat-dashboard-pro-bootstrap/"
    />
    <meta
      property="og:image"
    ...
    <link
      rel="icon"
      type="image/x-icon"
      href="{{ asset('asset') }}/assets/img/favicon/favicon.ico"
    />
    ...
    <link
      rel="stylesheet"
      href="{{ asset('asset') }}/assets/vendor/libs/pickr/pickr-themes.css"
    />
    ...
    <link
      rel="stylesheet"
      href="{{ asset('asset') }}/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.css"
    />
    ...
    <link
      rel="stylesheet"
      href="{{ asset('asset') }}/assets/vendor/libs/@form-validation/form-validation.css"
    />
    ...
    <script src="{{ asset('asset') }}/assets/vendor/js/template-customizer.js"></script>
  ...
  <body>
    ...
    <script src="{{ asset('asset') }}/assets/vendor/libs/@form-validation/bootstrap5.js"></script>
    <script src="{{ asset('asset') }}/assets/vendor/libs/@form-validation/auto-focus.js"></script>
    ...
    <!-- Page JS -->
    <script src="{{ asset('asset') }}/assets/js/pages-auth.js"></script>
  </body>
</html>