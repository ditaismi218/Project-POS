    ...
    <div class="card shadow-sm p-4">
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                ...
                <input type="text" class="form-control bg-light" value="{{ $penjualan->member->nama ?? 'Pelanggan Lain' }}"
                    readonly>
            </div>
            <div class="col-md-6">
        ...
        <form action="{{ route('pembayaran.store') }}" method="POST">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <input type="number" id="jumlahBayar" name="jumlah_bayar" class="form-control" required
