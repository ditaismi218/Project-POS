                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-warning edit-button" 
                                        data-id="{{ $item->id }}"
                                        data-kode="{{ $item->kode_member }}"
                                        data-nama="{{ $item->nama }}"
                                        data-telp="{{ $item->no_telp }}"
                                        data-alamat="{{ $item->alamat }}"
                                        data-tgl="{{ $item->tgl_bergabung }}"
                    ...
                    <form id="productForm" method="POST" action="{{ route('member.store') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="no_telp" name="no_telp" 
                                   maxlength="12" oninput="this.value = this.value.slice(0, 12)" required>
                        </div>
                ...
                <div class="modal-body">
                    <form id="editForm" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="kode_member-edit" 
                                   name="kode_member" readonly>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="no_telp-edit" 
                                   name="no_telp" maxlength="12" required>
                        </div>

                        <div class="mb-3">
                            <label for="alamat-edit" class="form-label">Alamat</label>
                            <textarea class="form-control" id="alamat-edit" 
                                      name="alamat" rows="2" required></textarea>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control" id="tgl_bergabung-edit" 
                                   name="tgl_bergabung" required>
                        </div>
...
<script>
    $(document).ready(function() {
        ...
        $(document).on('click', '.edit-button', function() {
            ...
            console.log('Editing member:', {id, kode, nama, telp, alamat, points, tgl});
